                                                ...
                                                <div className="tab-content b-0 mb-0 pt-0">
                                                    ...
                                                    <div className="tab-pane active" id="account-2">
                                                        <div className="row">
                                                            ...
                                                            <div class="mb-4">
                                                                <h3 class="text-center mb-2" style={{letterSpacing: "-1px"}}>Sell Data</h3> 
                                                                <h6 class="card-subtitle text-muted text-center">Buy & Renew your data subscription here</h6>
                                                            </div>
                                                                ...
                                                                <div className="row">
                                                                   <div className='col-md-12'>
                                                                    <div class="mb-2">
                                                                            ...
                                                                            <select class="form-select" id="validationCustom04" required="">
                                                                                <option selected="" disabled="" value="">Choose...</option>
                                                                                {["1GB for ₦300", "2.5GB for ₦500", "6GB for ₦1,500", "10GB for ₦5,000"].map((network)=>(<option>{network}</option>))}
                                                                            </select>   
                                                                        </div>
                                                                   </div>
                                                                </div>
                                                                ...
                                                                <div className='row mb-2'>
                                                                    ...
                                                                    <div className='col-6'>
                                                                        <div class="">
                                                                        <label for="phone">Notification Number</label>
                                                    ...
                                                    <div className="tab-pane" id="profile-tab-2">
                                                        <div className="row">
                                                            <div className="col-md-6  offset-md-3">
                                                                ...
                                                                <h3 className='mt-0 ' style={{color:"#555"}}>2.5GB Data Bundle</h3>
                                                                <p className='mb-0 '>Amount</p>
                                                                <h4 className='mt-0 ' style={{color:"#555"}}>₦ 500.0</h4>
                                                                <p className='mb-0 '>Phone Number</p>
                                                                <h3 className='mt-0 ' style={{color:"#555"}}>08137331445</h3>
                                                                <p className='mb-0 '>Notification Number</p>
                                                                <h4 className='mt-0 ' style={{color:"#555"}}>08088191618</h4>
                                                    ...
                                                    <div className="tab-pane" id="finish-2">
                                                        ...
                                                        <div className="col-md-6  offset-md-3">
                                                                ...
                                                                <h4 className='mt-0 ' style={{color:"#555"}}>₦ 550</h4>
                                                                <p className='mb-0 '>Service Charge</p>
                                                                <h4 className='mt-0 ' style={{color:"#555"}}>₦ 50</h4>
                                                                <p className='mb-0 '>Transaction ID</p>
                                                                <h4 className='mt-0 ' style={{color:"#555"}}>3452597004</h4>
                                                                <div className='row mt-4'>
                                                                    <div className='col-6'>
