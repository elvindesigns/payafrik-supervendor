...
export default function SellElectricity() {
  return (
                                                ...
                                                <div className="tab-content b-0 mb-0 pt-0">
                                                    ...
                                                    <div className="tab-pane active" id="account-2">
                                                        <div className="row">
                                                            ...
                                                            <div class="mb-4">
                                                                <h3 class="text-center mb-2" style={{letterSpacing: "-1px"}}>Sell Electricity</h3> 
                                                                <h6 class="card-subtitle text-muted text-center">Want to pay electricity bills? You can buy power units easily here</h6>
                                                            </div>
                                                                <div className='row mb-2'>
                                                                    ...
                                                                    <div className='col-6'>
                                                                        <div class="">
                                                                        <label for="lname">MeterType</label>
                                                                        <select class="form-select" id="validationCustom04" required="">
                                                                                <option selected="" disabled="" value="">Choose...</option>
                                                                                {["Prepaid","Postpaid"].map((state)=>(<option>{state}</option>))}
                                                                            </select>  
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div className="tab-pane" id="finish-2">
                                                        ...
                                                        <div className="col-md-6  offset-md-3">
                                                                ...
                                                                <h3 className='mt-0 ' style={{color:"#8ca23b"}}>0097 0349 8736 0760 4254</h3>
                                                                <p className='mb-0 '>No. of Units</p>
                                                                <h3 className='mt-0 ' style={{color:"#555"}}>106.4</h3>
                                                                <p className='mb-0 '>Meter Number</p>
